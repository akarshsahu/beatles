...
# Load the data file
df <- read.csv("C:\\Users\\ASahu\\Desktop\\Data Sciences\\ShinyApp\\Beatles_Live_Performances.csv", stringsAsFactors = FALSE)
...
shinyServer(function(input, output, session) {
  ...
  output$markPlot <- renderGvis({
    gvisMap(locations_distinct(), "LatLng", "Tip", options=list(showTip=TRUE, showLine=TRUE, enableScrollWheel=TRUE,
             mapType='map', useMapTypeControl=TRUE,width=800,height=400))
  })
